...
static int8_t print_result(Image* img)
{
    ...
    {
        stream.str("");
        stream << "Age & Gender Model Time: " << std::setw(3) << ai_time << "msec";
        str2 = stream.str();
                        ...
                        for(i = 0; i < face_count_local; i++)
                        {
                            ...
                            while(1)
                            {
                                ...
                                else
                                {
                                    ...
                                    age_gender_time[i] = age_gender_time[i] = (uint32_t)((timedifference_msec(start_time, inf_end_time)*TIME_COEF));
